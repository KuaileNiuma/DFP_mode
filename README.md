...
- [DFP 的创建](#dfp-的创建)
    - [1 .PDSC 文件](#1-pdsc-文件)
        ...
        - [1.4 文件格式](#14-文件格式)
            - [1.4.1 结构示例](#141-结构示例)
            - [1.4.2 关键部分示例](#142-关键部分示例)
    - [2 DFP 文件结构](#2-dfp-文件结构)
        - [2.1 Device 目录](#21-device-目录)
            - [2.1.1 startup_device.s](#211-startup_devices)
            - [2.1.2 system_device.c](#212-system_devicec)
            - [2.1.3 system_device.h](#213-system_deviceh)
            - [2.1.4 device.h](#214-deviceh)
            - [2.1.5 Driver 目录](#215-driver-目录)
        - [2.2 Flash 目录](#22-flash-目录)
            - [2.2.1 操作流程](#221-操作流程)
            - [2.2.2 修改 FlashDev.c](#222-修改-flashdevc)
            - [2.2.3 修改 FlashPrg.c](#223-修改-flashprgc)
            - [2.2.4 生成 FLM](#224-生成-flm)
        - [2.3 SVD 目录](#23-svd-目录)
            - [2.3.1 介绍](#231-介绍)
            - [2.3.2 文件格式](#232-文件格式)
            - [2.3.3 各元素解析](#233-各元素解析)
            - [2.3.4 文件生成](#234-文件生成)
    - [3 生成 PACK](#3-生成-pack)
---
