...
if [ `uname -s` = "Linux" ]
  ...
  CMSIS_PACK_PATH="D:/Keil_v5/Arm/Packs/ARM/CMSIS/6.1.0"  #---# 1.修改CMSIS版本路径；
  PATH_TO_ADD="\"D:/Program Files/7-Zip/\":D:/Keil_v5/Keil_v5/ARM/cmsis-toolbox/bin/"
  #---# 2.修改7.ZIP和CMSIS工具（如 PackChk.exe）位置；
fi
