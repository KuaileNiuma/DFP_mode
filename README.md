...
- 本文档是本人学习过程中的总结，旨在提供关于 DFP（Device Family Pack）创建和使用的详细说明。如果有任何问题或建议，欢迎大家指出。
...
1. [DFP 的创建](#dfp-的创建)
    - [1.1 .PDSC 文件](#11-pdsc-文件)
        - [1.1.1 介绍](#111-介绍)
        - [1.1.2 参考文档](#112-参考文档)
        - [1.1.3 命名格式](#113-命名格式)
        - [1.1.4 文件格式](#114-文件格式)
            - [1.1.4.1 结构示例](#1141-结构示例)
            - [1.1.4.2 关键部分示例](#1142-关键部分示例)
    - [1.2 DFP 文件结构](#12-dfp-文件结构)
        - [1.2.1 Device 目录](#121-device-目录)
            - [1.2.1.1 startup_device.s](#1211-startup_devices)
            - [1.2.1.2 system_device.c](#1212-system_devicec)
            - [1.2.1.3 system_device.h](#1213-system_deviceh)
            - [1.2.1.4 device.h](#1214-deviceh)
            - [1.2.1.5 Driver 目录](#1215-driver-目录)
        - [1.2.2 Flash 目录](#122-flash-目录)
            - [1.2.2.1 操作流程](#1221-操作流程)
            - [1.2.2.2 修改 FlashDev.c](#1222-修改-flashdevc)
            - [1.2.2.3 修改 FlashPrg.c](#1223-修改-flashprgc)
            - [1.2.2.4 生成 FLM](#1224-生成-flm)
        - [1.2.3 SVD 目录](#123-svd-目录)
            - [1.2.3.1 介绍](#1231-介绍)
            - [1.2.3.2 文件格式](#1232-文件格式)
            - [1.2.3.3 各元素解析](#1233-各元素解析)
            - [1.2.3.4 文件生成](#1234-文件生成)
    - [1.3 生成 PACK](#13-生成-pack)
---
